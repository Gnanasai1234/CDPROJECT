...
import com.klef.jfsd.springboot.service.EmployeeServiceImpl;
...
public class EmployeeController 
{
	...
	@GetMapping("empsessionfailed")
	public ModelAndView empsessionfail(HttpServletRequest request)
	{
		HttpSession session=request.getSession();
		
		session.removeAttribute("employee");
		ModelAndView mv=new ModelAndView();
		mv.setViewName("empsessionfailed");
		return mv;
	}
